...
- CodeFree-O 1.4.0 or later installed and signed in for the preferred token authentication flow. The complete official 1.7.0 platform matrix is reviewed.
